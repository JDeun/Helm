# Helm 0.2.0 Release Checklist

Use this checklist before cutting the `0.2.0` release.

## Version and metadata

- confirm `pyproject.toml` version is `0.2.0`
- confirm `setup.py` version is `0.2.0`
- confirm `CHANGELOG.md` includes `0.2.0`
...
- draft GitHub release notes from `docs/releases/0.2.0.md`
