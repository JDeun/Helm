...
<p align="center"><strong>Current release: v0.5.7</strong></p>
...
Helm v0.5.7 hardens workspace detection, checkpoint routing, and read-only survey behavior so operational inspection is less likely to report the wrong root or mutate state by accident.
