...
<p align="center"><strong>현재 릴리즈: v0.5.8</strong></p>
...
Helm v0.5.8은 context 로딩, checkpoint 복원, adaptive harness 라우팅, file-intake 분류 같은 감사 핵심 경계를 더 엄격하게 다듬어 inspection 경로가 더 안전하게 실패하고 증거 캡처 정합성이 유지되도록 한 릴리즈입니다.
