...
<p align="center"><strong>현재 릴리즈: v0.5.7</strong></p>
...
Helm v0.5.7은 workspace 탐지, checkpoint 라우팅, read-only survey 동작을 더 엄격하게 다듬어 잘못된 루트를 읽거나 검사만으로 상태를 만들 가능성을 줄이는 릴리즈입니다.
